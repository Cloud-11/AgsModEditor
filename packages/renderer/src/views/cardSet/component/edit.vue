  ...
  >
    <el-scrollbar height="50vh">
      <el-form
        ...
        label-suffix="："
      >
        <el-form-item label="卡组ID" prop="id">
          <el-col :span="24">
            <el-input v-model="ruleForm.id"></el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="卡组名称" prop="displayName">
          <el-col :span="24">
            <el-input v-model="ruleForm.displayName"></el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="卡牌图鉴类别" prop="displayNameInCardLibrary">
          <el-col :span="24">
        ...
        <el-form-item label="卡牌组标签" prop="tagCode">
          <el-input
            v-model="ruleForm.tagCode"
            placeholder="请输入卡牌组标签"
          ></el-input>
        </el-form-item>
        <el-form-item label="包含卡牌" prop="cardIds">
          <el-select
            multiple
...
export default {
  ...
  setup() {
    ...
    type cardSetDialogState = {
      isShowDialog: boolean;
      isEdit: boolean;
      ruleForm: cardSet;
      cardsData: card[];
    };
    const state: cardSetDialogState = reactive({
      isShowDialog: false,
      isEdit: false,
      ruleForm: {
        id: "",
        ...
        availableForCharacterId: "Shared",
        section: "Shared",
        tagCode: "",
        cardIds: [],
      },
